...
import { getUserProfile, updateUserProfile, checkUserSession } from '../../services/userService';
...
const UserProfile = () => {
  ...
  const handleUserUpdate = async () => {
    ...
    if (!isNameValid || !isEmailValid || !isMobileValid) return;

    try {
      await updateUserProfile(userId, editUser);
